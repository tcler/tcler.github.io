...
tmux new -d "./nfs4server.py -r -v --is_ds --exports=ds_exports --port=12345" \; pipe-pane "exec cat >/tmp/ds.log"
tmux new -d "./nfs4server.py -r -v --use_files --dataservers=dataservers.conf" \; pipe-pane "exec cat >/tmp/mds.log"
