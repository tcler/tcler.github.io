...
00000468
[student@workstation ~]$ dd if=/dev/zero of=ext4.img bs=256 count=1  seek=1024  conv=notrunc oflag=seek_bytes
1+0 records in
1+0 records out
...
mount: wrong fs type, bad option, bad superblock on /dev/loop0,
       ...
       dmesg | tail or so.
[student@workstation ~]$ dd if=ext4.img skip=$((32768*4096)) iflag=skip_bytes of=ext4.img bs=256 count=1  seek=1024  conv=notrunc oflag=seek_bytes
1+0 records in
1+0 records out
